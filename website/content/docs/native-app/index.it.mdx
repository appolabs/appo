...
Per la specifica completa del protocollo dei messaggi, vedi [Architettura](/docs/sdk/architecture).

## Sezioni

- [Configurazione](/docs/native-app/configuration) — Impostazioni dell'app, permessi e deep link
- [Gestori Funzionalità](/docs/native-app/handlers) — Come i gestori nativi processano le richieste dell'SDK
- [Trasmissione Eventi](/docs/native-app/event-broadcasting) — Consegna degli eventi dal nativo al web
