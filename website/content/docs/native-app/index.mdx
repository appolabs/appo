...
For the full message protocol specification, see [Architecture](/docs/sdk/architecture).

## Sections

- [Configuration](/docs/native-app/configuration) — App settings, permissions, and deep links
- [Feature Handlers](/docs/native-app/handlers) — How native handlers process SDK requests
- [Event Broadcasting](/docs/native-app/event-broadcasting) — Native-to-web event delivery
