...
description: Create a native app from your website using the Appo dashboard or a platform plugin.
---
...
For the native bridge to work, your website needs the Appo SDK installed. See [Installation](/docs/getting-started/installation) for setup instructions.
...
- [Configure your app](/docs/native-app/configuration) — Understand permissions, deep links, and platform settings.
- [Feature Handlers](/docs/native-app/handlers) — How native handlers process SDK requests.
- [Publishing](/docs/publishing) — How Appo builds and publishes your app.
