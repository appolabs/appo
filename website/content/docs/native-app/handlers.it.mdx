...
Crea un modulo funzionalita corrispondente nell'SDK in modo che `appo.myfeature.doSomething()` invii il tipo di messaggio corretto. Vedi l'[architettura dell'SDK](/sdk/architecture) per il protocollo dei messaggi.
