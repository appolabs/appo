...
- [x] **CLI-03** Preview / open-on-device — `appo preview` renders a terminal QR + prints TestFlight/deeplink, from the user-PAT preview surface; parity with the `preview_app` MCP tool (apps-web-app Phase 188). Deferrable — off the critical path.
